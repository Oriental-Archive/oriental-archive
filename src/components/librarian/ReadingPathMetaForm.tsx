...
export function ReadingPathMetaForm(props: {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setBusy(true);
    try {
      const res = await fetch(`/api/admin/reading-paths/${props.readingPathId}`, {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ title, topic: topic || null, description: description || null }),
      });
      if (!res.ok) {
